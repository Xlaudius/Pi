class PropertyStreetLocationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @property_street_location.save
        format.html { redirect_to @property_street_location, notice: 'Street Location was successfully created.' }
  ...
  def update
      respond_to do |format|
        if @property_street_location.update(property_street_location_params)
          format.html { redirect_to @property_street_location, notice: 'Street Location was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to property_street_location_url, notice: 'Street Location was successfully destroyed.' }
  ...
  private
    ...
    def set_property_street_location
      @property_street_locations = PropertystreetLocation.find(params[:id])
    end

    # Never trust parameters from the scary internet, only allow the white list through.
    def property_street_location_params
      params.require(:property_street_location).permit(:properties_id, :street_locations_id)
    end
end
