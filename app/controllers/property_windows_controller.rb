class PropertyWindowsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @property_window.save
        format.html { redirect_to @property_window, notice: 'Street Location was successfully created.' }
  ...
  def update
      respond_to do |format|
        if @property_window.update(property_window_params)
          format.html { redirect_to @property_window, notice: 'Street Location was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to property_window_url, notice: 'Street Location was successfully destroyed.' }
  ...
  private
    ...
    def set_property_window
      @property_windows = PropertyWindow.find(params[:id])
    end

    # Never trust parameters from the scary internet, only allow the white list through.
    def property_window_params
      params.require(:property_window).permit(:windows_id, :properties_id)
    end
end
